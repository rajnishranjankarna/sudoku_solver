# -*- coding: utf-8 -*-
"""
Created on Wed May 17 12:06:18 2023
...
def biggestContour(contours):
    ...
    for i in contours:
        ...
        if area > 50:
            ...
            approx = cv2.approxPolyDP(i, 0.02 * peri, True)  # corners point detection
            if area > max_area and len(approx) == 4:         # 4 corners means looking for rectangle or square contour
                biggest = approx
                max_area = area
